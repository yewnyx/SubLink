...
public static class HttpResponseUtils {
    ...
    public static async Task<T> ReadAsJsonAsync<T>(this HttpContent content,
        ...
        var json = await JsonSerializer.DeserializeAsync<T>(jsonStream, jsonSerializerOptions, cancellationToken) ?? throw new OpenShockSdkError("Failed to deserialize response json");
        return json;
    }
}