...
using tech.sublink.SubLinkEditor.Controls.Utils;

namespace tech.sublink.SubLinkEditor.Controls.NetworkModel;

/// <summary>
/// Defines a connector (aka connection point) that can be attached to a node and is used to connect the node to another node.
/// </summary>
internal sealed class ConnectorViewModel : AbstractModelBase {
    /// <summary>
    ...
    public ConnectorType Type {
        get {
            if (SourceSlot == null || ParentNode == null)
    ...
    /// 
    /// </summary>
    public NodeSlot SourceSlot { get; }
    ...
    public ConnectorViewModel(NodeSlot slot) {
        SourceSlot = slot ?? throw new InvalidOperationException("ConnectorViewModel() NodeSlot is null");
