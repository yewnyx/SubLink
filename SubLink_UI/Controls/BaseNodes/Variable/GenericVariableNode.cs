...
namespace BaseNodes.Variable;

[Category("Variable")]
public abstract class GenericVariableNode<T> : VariableNode {
    private T? _value;

    protected VariableControlType ControlType { get; set; }
            ...
            switch (value) {
                ...
                default:
                    throw new InvalidCastException(
                        $"GenericVariableNode<T>.Value : object can not be converted to {typeof(T).Name}."
                    );
            }
    ...
    protected GenericVariableNode(XmlNode node) : base(node) { }
    ...
    protected override object LoadValue(XmlNode node) =>
        (T)Convert.ChangeType(node.InnerText, typeof(T));
...
public class VariableNodeObject : GenericVariableNode<object> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeObject { Value = Value };
        return node;
    }
}
...
public class VariableNodeString : GenericVariableNode<string> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeString { Value = Value };
        return node;
    }
}
...
public class VariableNodeBool : GenericVariableNode<bool> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeBool { Value = Value };
        return node;
    }
}
...
public class VariableNodeByte : GenericVariableNode<sbyte> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeByte { Value = Value };
        return node;
    }
}
...
public class VariableNodeChar : GenericVariableNode<char> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeChar { Value = Value };
        return node;
    }
}
...
public class VariableNodeShort : GenericVariableNode<short> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeShort { Value = Value };
        return node;
    }
}
...
public class VariableNodeInt : GenericVariableNode<int> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeInt { Value = Value };
        return node;
    }
}
...
public class VariableNodeLong : GenericVariableNode<long> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeLong { Value = Value };
        return node;
    }
}
...
public class VariableNodeFloat : GenericVariableNode<float> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeFloat { Value = Value };
        return node;
    }
}
...
public class VariableNodeDouble : GenericVariableNode<double> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeDouble { Value = Value };
        return node;
    }
}
...
public class VariableNodeUByte : GenericVariableNode<byte> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeUByte { Value = Value };
        return node;
    }
}
...
public class VariableNodeUShort : GenericVariableNode<ushort> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeUShort { Value = Value };
        return node;
    }
}
...
public class VariableNodeUInt : GenericVariableNode<uint> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeUInt { Value = Value };
        return node;
    }
}
...
public class VariableNodeULong : GenericVariableNode<ulong> {
    ...
    protected override SequenceNode CopyImpl() {
        var node = new VariableNodeULong { Value = Value };
        return node;
    }
}
