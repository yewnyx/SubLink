...
public class BranchNode : ActionNode {
    ...
    public BranchNode(XmlNode node) : base(node) { }
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (objCond != null) {
            ...
            ActivateOutputLink(context, cond ? (int)NodeSlotId.OutTrue : (int)NodeSlotId.OutFalse);
        }
...
public class DoNNode : ActionNode {
    ...
    public DoNNode(XmlNode node) : base(node) { }
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (slot.Id == (int)NodeSlotId.InReset) {
            ...
            if (_counter < (int)memoryItem.Value) {
                SetValueInSlot((int)NodeSlotId.VarCounter, _counter++);
...
public class DoOnceNode : ActionNode {
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        var memoryItem = context.CurrentFrame.GetValueFromId(Id)
            ?? context.CurrentFrame.Allocate(Id, false);
...
public class FlipFlopNode : ActionNode {
    ...
    public FlipFlopNode(XmlNode node) : base(node) { }
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        var memoryItem = context.CurrentFrame.GetValueFromId(Id)
            ?? context.CurrentFrame.Allocate(Id, true);
        ...
        if (slot.Id == (int)NodeSlotId.InEnter) {
            ...
            ActivateOutputLink(context, val ? (int)NodeSlotId.OutA : (int)NodeSlotId.OutB);
        }
...
public class ForLoopNode : ActionNode {
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (slot.Id == (int)NodeSlotId.In) {
            ...
            var memoryItem = context.CurrentFrame.GetValueFromId(Id)
                ?? context.CurrentFrame.Allocate(Id, new ForLoopNodeInfo { Counter = firstIndex, IsWaitingLoopBody = false });
...
public class GateNode : ActionNode {
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (slot.Id == (int)NodeSlotId.InEnter && val)
            ActivateOutputLink(context, (int)NodeSlotId.Out);
