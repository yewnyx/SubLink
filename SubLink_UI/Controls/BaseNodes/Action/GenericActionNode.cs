...
public abstract class MathLogicOperatorNode<T> : ActionNode {
    ...
    public MathLogicOperatorNode(XmlNode node) : base(node) { }
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (objA != null && objB != null) {
            ...
            ActivateOutputLink(context, res ? (int)NodeSlotId.OutTrue : (int)NodeSlotId.OutFalse);
        }
...
public abstract class MathCastOperatorNode<TIn, TOut> : ActionNode {
    ...
    public MathCastOperatorNode(XmlNode node) : base(node) { }
...
public abstract class MathRandomNode<T> : ActionNode {
    ...
    public MathRandomNode(XmlNode node) : base(node) { }
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (objMin != null && objMax != null) {
            ...
            if (typeVal == typeof(double) || typeVal == typeof(float)) {
...
public abstract class VariableSetNode<T> : ActionNode {
    ...
    public VariableSetNode(XmlNode node) : base(node) { }
    ...
    public override ProcessingInfo ActivateLogic(ProcessingContext context, NodeSlot slot) {
        ...
        if (objVariable != null && objValue != null) {
...
[Name("String")]
public class VariableSetNodeString : VariableSetNode<string> {
