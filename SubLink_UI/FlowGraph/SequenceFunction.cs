...
public class SequenceFunction : SequenceBase {
    ...
    public delegate void ReturnEvent(ProcessingContext context);
    public event ReturnEvent OnReturn;
    ...
    public SequenceFunction(string? name) : base(name) {
    ...
    public SequenceFunction(XmlNode node) : base(node) {
        _slots.CollectionChanged += OnSlotCollectionChanged;
    }
    ...
    public void Return(ProcessingContext context) =>
        OnReturn?.Invoke(context);
}
