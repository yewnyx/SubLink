...
namespace FlowGraph.Node.StandardVariableNode;
...
public sealed class NamedVariableNode : VariableNode {
    ...
    public NamedVariableNode(XmlNode node) : base(node) {
        InitializeSlots();
    }
    ...
    protected override SequenceNode CopyImpl() =>
        new NamedVariableNode(_value.Name);
    ...
    protected override object LoadValue(XmlNode node) =>
        NamedVariableManager.Instance.GetNamedVariable(node.Attributes["varName"].Value);
