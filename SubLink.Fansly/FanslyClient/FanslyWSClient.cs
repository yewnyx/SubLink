...
using WebSocket4Net;
using xyz.yewnyx.SubLink.Fansly.FanslyClient.APIDataTypes;
using xyz.yewnyx.SubLink.Fansly.FanslyClient.SocketDataTypes;

namespace xyz.yewnyx.SubLink.Fansly.FanslyClient;

internal sealed class FanslyWSClient {
    ...
    public FanslyWSClient(ILogger logger) {
        _logger = logger;
